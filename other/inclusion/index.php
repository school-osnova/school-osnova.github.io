...
<html>
	<head>
		<title>Інклюзивне навчання - ЗЗОШ "ОСНОВА"</title>
			...
			<!-- Main -->
				<article id="main">
					...
					<section class="wrapper style2 container special-alt">
						<header class="special container">
							<h3><strong>Інклюзія: як розшифрувати?</strong></h3>
						</header>
						<section class="wrapper style2 container special-alt">
							<h3>
								Інклюзія (від <strong>Inclusion</strong> – включення) – процес збільшення ступеня участі всіх громадян у соціальному житті. Це політика й процес, що дає можливість всім дітям брати участь у всіх програмах.
								<br />
							...
							<h3>
								...
								<br />
								надання рівного доступу до освіти або створення спеціальних умов для певних категорій дітей
								<br />
								без їх виключення.
							</h3>
							<h2>
						...
						<header class="special container">
							<h3><strong>Ключові елементи інклюзивної освіти</strong></h3>
						</header>
						<section class="wrapper style2 container special-alt">
							<h2>
						...
						<header class="special container">
							<h3><strong>Основні принципи та цінності інклюзивної освіти</strong></h3>
						</header>
						...
						<header class="special container">
							<h3><strong>Інтеграція vs. інклюзія</strong></h3>
						</header>
						<section class="wrapper style2 container special-alt">
							<h3>
						...
						<header class="special container">
							<h3><strong>Переваги інклюзивної освіти:</strong></h3>
						</header>
						<section class="wrapper style2 container special-alt">
							<h2>
