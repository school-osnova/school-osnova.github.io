...
<html>
	<head>
		<title>Установчі документи навчального закладу - ЗЗОШ "ОСНОВА"</title>
			...
			<!-- Main -->
				<article id="main">
					...
					<header class="special container">
						...
						<h2>Установчі документи навчального закладу</h2>
						<br />
					...
					<!-- One -->
						<section class="wrapper style3 container special-alt">
							<header class="special container">
								...
								<img border="0" height="400" src="assets/doc/doc-1.jpg" width="290">
								<img border="0" height="400" src="assets/doc/doc-2.jpg"width="290">
								<img border="0" height="400" src="assets/doc/doc-3.jpg"width="290">
								<img border="0" height="400" src="assets/doc/doc-4.jpg" width="290">
								<img border="0" height="400" src="assets/doc/doc-5.jpg" width="290">
								<br />
								<header class="special container"></header>
